//src/app/admin/users/components/AdminUsersInteractive.tsx
'use client';
...
export default function AdminUsersInteractive() {
  ...
  async function handleAction(action: "suspend" | "delete" | "activate") {
        ...
        {selectedUsers.length > 0 && (
          <div className="flex items-center gap-3 p-3 bg-primary/10 border border-primary/20 rounded-md">
            ...
            <button
              ...
              className="px-3 py-1.5 text-sm bg-success text-white rounded-md hover:bg-success/90"
            >
              Activate
            </button>
            <button onClick={() => handleAction("suspend")} className="px-3 py-1.5 text-sm bg-warning text-warning-foreground rounded-md hover:bg-warning/90 transition-colors duration-200 flex items-center gap-1">
              <Icon name="PauseIcon" size={16} />
              Suspend
            </button>
            <button onClick={() => handleAction("delete")} className="px-3 py-1.5 text-sm bg-error text-error-foreground rounded-md hover:bg-error/90 transition-colors duration-200 flex items-center gap-1">
